<?php /* Smarty version Smarty-3.1.19, created on 2014-07-29 15:00:48
...
" />
                        <input type="button" value="Сохранить" class="btn btn-block btn-success" onclick="updateDatePayment('<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
');" />
                    </td>
